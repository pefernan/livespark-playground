...
public class User implements java.io.Serializable
{
   ...
   public void setMarried(final java.lang.Boolean married)
   {
   ...
   public void setAddress(final demo.client.shared.Address address)
   {
   ...
   public void setAdresses(final java.util.List<demo.client.shared.Address> adresses)
   {
      this.adresses = adresses;
   }

   public User(final java.lang.Long id, final java.lang.String name,
         final java.lang.String lastName, final java.util.Date birthday,
         final java.lang.Boolean married, final java.lang.String title,
         final demo.client.shared.Address address,
         final java.util.List<demo.client.shared.Address> adresses)
   {
      this.id = id;
      this.name = name;
      this.lastName = lastName;
